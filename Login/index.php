...
<body>
    ...
    <div class="sidebar">
        <h2>Menu</h2>
        <a href="/odonto-helio/Gráfico%20Periodontal.html">Periograma</a>
        <?php if ($nivel == 3): ?>
            <a href="/odonto-helio/Login/tela_cadastro.html" class="disabled-link">Cadastro</a>
        <?php else: ?>
            <a href="/odonto-helio/Login/tela_cadastro.html">Cadastro</a>
        <?php endif; ?>
